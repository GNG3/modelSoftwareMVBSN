multivariateBernoulliNetworkLerouxTauMHHalfNormalPrior = function(formula, 
                                              data, 
  ...
  initialSpatialTau = rep(1, numberOfResponses)
  ...
  spatialTauTuningParameters = rep(1, numberOfResponses)
  spatialTauAcceptanceRate = rep(0, numberOfResponses)
  numberOfAcceptedSpatialTauDraws = rep(0, numberOfResponses)
  numberOfAllAcceptedSpatialTauDraws = rep(0, numberOfResponses)
  ...
  if(is.null(trueSpatialTau)) {
    spatialTauFixed = FALSE
    trueSpatialTauValues = initialSpatialTau
  } else {
    spatialTauFixed = TRUE
    trueSpatialTauValues = trueSpatialTau
  }
  ...
  output = multivariateBernoulliNetworkLerouxTauMHHalfNormalPriorAllUpdate(standardizedX = standardizedX,
                                                       y = y,
                                                       ...
                                                       spatialTauTuningParameters = spatialTauTuningParameters,
                                                       spatialTauAcceptanceRate = spatialTauAcceptanceRate,
                                                       numberOfAcceptedSpatialTauDraws = numberOfAcceptedSpatialTauDraws,
                                                       numberOfAllAcceptedSpatialTauDraws = numberOfAllAcceptedSpatialTauDraws,
                                                       ...
                                                       sigmaSquaredSpatialTau = sigmaSquaredSpatialTau,
                                                       xi = xi,
                                                       omega = omega,
                                                       ...
                                                       spatialTauFixed = spatialTauFixed,
                                                       ...
                                                       trueSpatialTauValues = trueSpatialTauValues,
  ...
  spatialTauAcceptanceRate = output[[10]]
  spatialRhoAcceptanceRate = output[[11]]
  varianceCovarianceUAcceptanceRate = rep(1, numberOfResponses  + (numberOfResponses * numberOfResponses - numberOfResponses) / 2)
  
  acceptanceRates = c(betaAcceptanceRate, spatialTauAcceptanceRate, 
  ...
  colnames(spatialTauSamples) = paste("tau", seq(1, numberOfResponses)) 
  ...
  samples = cbind(betaSamples, spatialTauSamples, spatialRhoSamples, varianceCovarianceUSamples)
  
  DBar = output[[19]]
  posteriorDeviance = output[[20]]
  ...
  results = list(call = call,
                 ...
                 spatialTauSamples = spatialTauSamples,
  ...
  class(results) = "modelSoftwareMVBSN"
